...
void printBoard(Board *gameBoard) {
     printf("\n===================================================={ FreeCell Game }===================================================\n\n");
    // Afficher les num�ros de colonne pour Zone 2 et Zone 3
    ...
    printf("                 ");
        ...
        printf("\n");
    printf("\n------------------------------------------------------| Zone 1 |--------------------------------------------------------\n\n");
    // Afficher les num�ros de colonne  pour Zone 1
    printf("                      ");
    for (int i = 0; i < 8; i++) {
        printf("   %d     ", i + 1);
    }
...
int isMoveValid(Carte *sourceCard, Carte *destinationCard) {
    ...
    // V�rifier si la carte destination est de rang imm�diatement sup�rieur
    if (sourceCard->value == destinationCard->value - 1) {
        // V�rifier si les couleurs sont oppos�es
...
if (scanf("%2s", choixDestination) != 1) {
    afficherErreurAvecPause("Erreur de saisie.", 3000);
    continue;
}
...
int youWin(Board *gameBoard) {
    for (int i = 0; i < 4; i++) {
        ...
        // V�rifier si la carte sup�rieure est un Roi (valeur = 13)
...
void restartGame(Board *gameBoard) {
    // Lib�rer la m�moire des cartes existantes dans le plateau de jeu et r�initialiser les piles
    for (int i = 0; i < 8; i++) {
